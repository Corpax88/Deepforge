(function(){
  ...
  const BUILD={version:'0.26.7',name:'MOONGLASS COMPLETE'};
  ...
  function drawMossveinMineApproach(){
    ...
    const topLeft=worldToScreen(130,665),width=350,height=251;if(topLeft.x>viewWidth||topLeft.y>viewHeight||topLeft.x+width<0||topLeft.y+height<0)return;
