(function(){
  ...
  const BUILD={version:'0.28.0',name:'EMBERDEEP COMPLETE'};
  ...
  function drawEmberdeepMineApproach(){
    ...
    ctx.save();ctx.translate(topLeft.x+width,topLeft.y);ctx.scale(-1,1);ctx.drawImage(image,0,0,width,height);ctx.restore();
  }
