(function(){
  ...
  const BUILD={version:'0.28.4',name:'EMBERDEEP COMPLETE'};
  ...
  function spawnDiscoveryBurst(rock,label){
    ...
    sound('discovery',rock.type);miningKick(rare?9:7,rare?.24:.18,data.edge,rare?30:22);
  }
